...
for i in range(1, TYPE_PARAMETER_COUNT + 1):
    ...
    output.write("        public static " + FULL_NAME + " New<U>(U " +
                 ...
                 INDENT * 3 + " new " + FULL_NAME + "(" + VALUE_NAME + ");\n")
    #

    # public non-static MakeNew method
    output.write(
        INDENT * 2 + "/// <summary>\n" +
        INDENT * 2 + "/// Creates and returns a new " + FULL_NAME +"\n" +
        INDENT * 2 + "/// </summary>\n"
    )
    output.write(INDENT * 2 + "public " + FULL_NAME + " MakeNew<U>(U " + VALUE_NAME + ") where U : " +
                 to_delim_string(types) + " => \n" +
                 INDENT * 3 + " new " + FULL_NAME + "(" + VALUE_NAME + ");\n")
    #
    ...
    output.write(
        INDENT * 2 + "/// <summary>\n" +
        INDENT * 2 + "/// Returns a TypeArray containing all of the types that the value must extend or implement.\n" +
        INDENT * 2 + "/// </summary>\n"
    )
    output.write(INDENT * 2 + "public IEnumerable<Type> RequiredTypes => new TypeArray<" + to_delim_string(types) + ">();\n")
        #
    #
